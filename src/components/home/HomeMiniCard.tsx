...
export default function HomeMiniCard({
    ...
    const imageStylesOrder: Record<string, React.CSSProperties> = {
        "1": { width: "56px", height: "45px", marginTop: "3px" },
        "2": { width: "75px", height: "68px" },
        "3": { width: "60px", height: "49px" },
        "4": { width: "85px", height: "59px", marginTop: "-2px" },
        "11": { width: "60px", height: "65px", marginTop: "-2px" },
        "12": { width: "70px", height: "63px" },
        "13": { width: "65px", height: "55px", marginTop: "4px" },
        "14": { width: "55px", height: "59px" },
        "5": { width: "68px", height: "68px" },
        "6": { width: "68px", height: "68px" },
        "7": { width: "68px", height: "68px" },
        "8": { width: "68px", height: "68px" },
        "9": { width: "68px", height: "68px" },
        "10": { width: "68px", height: "68px" },
        "15": { width: "100px", height: "68px" },
        "16": { width: "82px", height: "62px", marginTop: "-2px" },
        "17": { width: "59px", height: "79px" },
        "18": { width: "49px", height: "48px" },
    };
