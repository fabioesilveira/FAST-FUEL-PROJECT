...
//   // filtro opcional: buscar por order_code dentro do user_id
...
//     if (status === "in_progress") return { label: "IN KITCHEN", hint: "On the make" };
...
//     try {
//       // backend seguro (recomendado): exige order_code + email
...
//   // Se não estiver logado, você usa o Track Order (guest) separado.
//   // Aqui só deixa a UI do usuário logado.
//   if (!isLogged) {
//     return (
...
//             >
//               <Chip
//                 label={activeKey === "completed" ? "YOUR COMPLETED ORDERS" : "YOUR CURRENT ORDERS"}
//                 size="small"
//                 sx={{
//                   fontSize: "0.72rem",
//                   letterSpacing: "0.1em",
...
//                       activeKey === "in_progress" && o.status === "sent" && !o.received_confirmed_at;
...
//                               }}
//                             >
//                               <Typography sx={{ fontWeight: 900, color: "#0d47a1", mb: 1 }}>
