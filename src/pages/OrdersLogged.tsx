...
export default function OrdersLogged() {
  ...
  // ✅ Ajuste: mensagens centralizadas (Loading / Empty) iguais ao padrão da outra página
          ...
          >
            ...
            <Box
              sx={{
                ...
                overflowY: "auto",
                pr: 0.5,
                display: "flex",          // ✅ necessário pro CenterMessage centralizar verticalmente
                flexDirection: "column",  // ✅ mantém o fluxo normal
              }}
            >
              {loading ? (
